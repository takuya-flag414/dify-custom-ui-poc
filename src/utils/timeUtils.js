 ...
 * @param {Date} currentTime - テスト用の時刻（省略時は現在時刻を使用）
 * @returns {Object} { greeting: string, subMessage: string }
 */
export const getTimeBasedGreeting = (userName = '', currentTime = new Date()) => {

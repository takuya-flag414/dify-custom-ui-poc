...
import { USE_ENV_API_CONFIG } from '../../config/env';
        ...
        return (
            <>
                ...
                <div className="input-group">
                    ...
                    <div className={`input-wrapper ${status === 'error' ? 'error' : ''} ${USE_ENV_API_CONFIG ? 'disabled' : ''}`}>
                ...
                <div className="input-group">
                    ...
                    <div className={`input-wrapper ${status === 'error' ? 'error' : ''} ${USE_ENV_API_CONFIG ? 'disabled' : ''}`}>
                        ...
                        <input
                            ...
                            value={USE_ENV_API_CONFIG ? '••••••••••••••••••••' : apiKey}
                            onChange={(e) => {
    ...
    return (
        <div className="api-modal-overlay">
            <div className="api-modal-container">
                ...
                {/* Env Config Notice */}
                {USE_ENV_API_CONFIG && (
                    <div className="env-config-notice">
                        <div className="notice-icon">
                            <InfoIcon width="18" height="18" />
                        </div>
                        <div className="notice-content">
                            現在、環境変数から設定を読み込んでいます。このメニューからの編集はできません。
                        </div>
                    </div>
                )}

    ...
    return (
        <div className="onboarding-step-new split-layout">
            <div className="onboarding-step-left">
                ...
                <div className="title-decoration-line" style={{ marginBottom: '24px' }} />
                ...
                <motion.p
                    ...
                    style={{ fontSize: '1.25rem', color: 'var(--color-text-sub)' }}
                >
            ...
            <div className="onboarding-step-right">
                ...
                >
                    {/* 上: スタイルカード */}
                    <div className="style-cards-section" style={{ display: 'flex', gap: '16px' }}>
                ...
                >
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        style={{ minWidth: '160px', marginLeft: '16px' }}
                    >
                        次へ
                    </motion.button>
                </motion.div>
